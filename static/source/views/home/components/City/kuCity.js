...
(function($) {
    ...
    var KuCity = function(target,point) {
    ...
    KuCity.prototype = {
        ...
        creatItem: function() {
            ...
            var template = '<div class="kucity" style="background-color:#FFF"><div class="citybox"><h3 class="kucity_header">热门城市(支持汉字/拼音搜索)</h3><ul class="kucity_nav"><li class="active">热门城市</li><li>ABCDEFGH</li><li>IJKLMNOP</li><li>QRSTUVWXYZ</li></ul><div class="kucity_body"></div></div><ul class="result"></ul></div>';
        ...
        citySelect: function() {
            ...
            $('.kucity_item dd').on('click', 'span', function(e) {
                console.log(self.parentPoint)
                self.parentPoint.selectCity($(e.target).text())
    ...
    var kucity = null;
    $.fn.kuCity = function(_this) {
        var target = $(this);
        target.on('focus', function(e) {
            var top = $(this).offset().top + $(this).outerHeight(),
                left = $(this).offset().left;
            kucity = kucity ? kucity : new KuCity(target,_this);
