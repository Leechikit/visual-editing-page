<style lang="less">
@import url('~@/views/home/Font-Awesome-3.2.1/css/font-awesome.min.css');
...
<template>
  <div class="form-rebuild-openModal">
    <div class="open-modal">
      ...
      <div id="divForward" style="display:none">
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <div
              id="forwardParticipant"
              data-width="100%"
              data-orgunitvisible="false"
              data-ismultiply="false"
              data-orgtagvisible="false"
            ></div>
          </div>
        </div>
        <div class="form-group">
...
export default {
  ...
  methods: {
    ...
    init() {
      $("ul[data-sheettoolbar='true']").attr('data-jcontrolid', '')
      sessionStorage.setItem('tabAppId', this.code)
      ...
      if (
        ...
        timeStamp =
          sheetContentCacheItem[$.SheetRuntimeContentCache.TimeStampName] - 0
        runtimeContent =
          sheetContentCacheItem[$.SheetRuntimeContentCache.SheetContentName]
        javascript =
          sheetContentCacheItem[$.SheetRuntimeContentCache.JavaScriptName]
      }
      ...
      HTTP.FormGet(param)
        .then(result => {
          ...
          if (result.Successful) {
            ...
            $('a.navbar-brand').attr('title', result.ReturnData.Name)
