...
;(function ($) {
	...
	Plugin.prototype = {
		...
		init: function () {
			 ...
			 * On down arrow click
			 */
			this.iconPicker.click($.proxy(function () {
				
								// Open/Close the icon picker
								this.toggleIconSelector();
				
							}, this));
			this.iconPicker.find('.selector-button').click($.proxy(function (e) {
			...
			this.iconPicker.find('.selector-arrow-right').click($.proxy(function (e) {
				e.stopPropagation();
			    //��ȡ��ǰѡ��Icon
			    var selectedIcon=this.currentIcon;
		...
		renderIconContainer: function () {
			...
			} else if (this.settings.emptyIconValue) {
			    this.setSelectedIcon(this.settings.emptyIconValue);
			}
		...
		toggleIconSelector: function () {
			...
			this.iconPicker.find('.selector-button i').toggleClass('icon icon-arrow-down2');
			this.iconPicker.find('.selector-button i').toggleClass('icon icon-arrow-down2');
			if (this.open) {
...
// WEBPACK FOOTER //
// ./src/lib/plugins/fontIconPicker/jquery.fonticonpicker.js