...
jQuery.extend({
    ...
    IModal: function (opt) {
        ...
        iModal.ShowModal = function (title, Content, ToolButtons) {
            ...
            this.ModalHeader = $('<div class="modal-header modal-header-form"><div class="close" data-dismiss="modal"><span aria-hidden="true" style="font-size:12px;"><i class="ivu-icon ivu-icon-close"></i></span></div></div>');
            //以下三个主要才是需要填充的
