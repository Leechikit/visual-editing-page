...
FormControls = {
    ...
    ApiTextArea: {
        ...
        DesignProperties: [
            ...
            // { Name: "Width", Text: "控件大小", Visiable: false, DefaultValue: "100%", ValueRange: [{ Val: "100%", Text: "大尺寸" }] },
    ...
    FormSeqNo: {
        ...
        DesignProperties: [
            ...
            { Name: "Prefix", Text: "前置字符(最多8位字母或数字)", DefaultValue: "", MaxLength: 8 },
            { Name: "ControlCode", Text: "控件标识", DefaultValue: "" },
    ...
    FormDateTime: {
        ...
        DesignProperties: [
            ...
            // { Name: "ComputationRule", Text: "计算公式", DefaultValue: "" },
            { Name: "DateTimeMode", Text: "格式", DefaultValue: "yyyy-mm-dd", ValueRange: [{ Val: "yyyy-mm-dd", Text: "年-月-日" }, { Val: "yyyy-mm", Text: "年-月" }, { Val: "yyyy-mm-dd hh:ii", Text: "年-月-日 时:分" }, { Val: "hh:ii", Text: "时:分" }] },
            { Name: "DefaultValueSetting", Text: "默认值", Visiable: true, DefaultValue: "", placeholder: '设置默认值' },
            { Name: "Description", Text: "描述", DefaultValue: "", Description: "" }
        ]
    },
    FormDateTimeStamp: {
    ...
    FormDropDownList: {
        ...
        DesignProperties: [
            ...
            { Name: "DisplayRule", Text: "隐藏条件", DefaultValue: "" },
            // { Name: "SelectShowMode", Text: "移动端显示模式", DefaultValue: "0", ValueRange: [{ Val: "0", Text: "侧滑选择" }, { Val: "1", Text: "平铺显示" }] },
            { Name: "DataSource", Text: "数据来源", DefaultValue: "Custom", ValueRange: [{ Val: "Custom", Text: "自定义" }, { Val: "Interface", Text: "关联外部接口" }] },
            { Name: "DataDictItemName", Text: "绑定数据字典", Visiable: false, DefaultValue: "" },
            { Name: "DefaultItems", Text: "选项", DefaultValue: ["选项1", "选项2", "选项3"] },
            { Name: "DefaultValue", Text: "默认值", Visiable: false },
            // //级联新增属性
            ...
            { Name: "InterfaceOptions", Text: "选项来源接口", DefaultValue: "" },
            { Name: "ShowMode", Text: "是否开启远程搜索（两个字符以上触发）", Visiable: true, DefaultValue: "0", ValueRange: [{ Val: "0", Text: "不开启" }, { Val: "1", Text: "开启" }] },
            { Name: "Description", Text: "描述", DefaultValue: "", Description: "" }
        ],
    },
    ...
    FormGridView: {
        ...
        DesignProperties: [
            ...
            { Name: "ExpandRange", Text: "展开收起", DefaultValue: "" }
    ...
    FormFormula: {
        ...
        DesignProperties: [
            ...
            { Name: "ControlCode", Text: "控件编码", DefaultValue: "", Description: "" }
        ]
    },
    FormEmbedCode: {
        Text: "代码内嵌",
        ...
        DesignProperties: [
            { Name: "DataField", Text: "控件编码", DefaultValue: "" },
            { Name: "DisplayName", Text: "控件名称", DefaultValue: "代码内嵌", Description: "" },
            { Name: "ControlCode", Text: "控件标识", DefaultValue: "" },
            { Name: "DisplayRule", Text: "隐藏条件", DefaultValue: "" },
            { Name: "InterfaceOptions", Text: "接口选择", DefaultValue: "" },
            //{ Name: "ComputationRule", Text: "计算公式", DefaultValue: "" },
            //{ Name: "BindType", Text: "类型", DefaultValue: "number", ValueRange: [{ Val: "number", Text: "数值" }, { Val: "text", Text: "文本" }, { Val: "datetime", Text: "日期" }, { Val: "boolean", Text: "是否" }] },
            //{ Name: "DecimalPlaces", Text: "格式", DefaultValue: "0", ValueRange: [{ Val: "0", Text: "整数" }, { Val: "2", Text: "两位小数" }, { Val: "3", Text: "三位小数" }, { Val: "4", Text: "四位小数" }] },
            //{ Name: "ShowMode", Text: "显示模式", DefaultValue: "0", ValueRange: [{ Val: "0", Text: "正常" }, { Val: "1", Text: "显示千位分隔符" }], Visiable: false },
    ...
    FormApprovalRecord: {
        ...
        DesignProperties: [
            { Name: "DataField", Text: "控件编码", DefaultValue: "" },
            { Name: "DisplayName", Text: "控件名称", DefaultValue: "审批记录", Description: "" },
            { Name: "ControlCode", Text: "控件标识", DefaultValue: "" },
            // { Name: "DisplayRule", Text: "隐藏条件", DefaultValue: "" },
            { Name: "Description", Text: "描述", DefaultValue: "", Description: "" }
        ]
...
FormControlAPI = {
    ...
    FormFolder: ["GetValue", "SetValue", "SetVisible", "BindChange", "UnBindChange"],

    FormList: ["GetValue", "SetValue", "SetVisible", "BindChange", "UnBindChange"],
    ...
    FormCitySelect: ["GetValue", "SetValue", "SetVisible", "BindChange", "UnBindChange"],
    ...
    ControlAPIDetails: {
        ...
        "ClearRows": { Type: "function", Demo: "（method）this.SubTable.ClearRows()", Summary: "���除子表的所有数据，参数说明：" },
