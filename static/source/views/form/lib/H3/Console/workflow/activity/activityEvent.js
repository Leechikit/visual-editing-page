export const ActivityEventSettings = {
    //属性标记名称
    PropertyAttrName: "activity-event-property"
}

export const ActivityEventStack = {
    //编辑控件容器
    Panel: void 0,
    //编辑单元格
    EditCells: void 0,
    //数据映射编辑框
    divEventDataMap: void 0,
    //当前活动
    CurrentActivity: void 0,
    //当前事件名称
    CurrentEventName: void 0,
    //当前事件对象
    CurrentActivityEvent: void 0,

    //复选控件:执行的动作
    MultipleSelect: void 0
}

export const ActivityEventEditor = function () {
    //编辑控件的容器
    ...
    if (!ActivityEventStack.MultipleSelect) {
        ...
        //启用选择控件
        ActivityEventStack.MultipleSelect.chosen();
        //设置宽度
        ActivityEventStack.MultipleSelect.parent().find("div.chosen-container-multi").width("300px");
    }
...
ActivityEventEditor.prototype.SetActivity = function () {
    ...
    if (_Configured)
        _DisplayDiv.text(_WorkflowDesigner_GlobalString.ActivityEvent_Set);
    else
        _DisplayDiv.text("");
...
ActivityEventEditor.prototype.Bind = function (_Activity, _EventName) {
    ...
    //删除按钮
    var _DeleteButton = $("<input type='button' value='" + _WorkflowDesigner_GlobalString.Button_Remove + "' />");

    var _tr = $("<tr></tr>");
    var _td = $("<td></td>");
    //添加新行
    var _AddNewRow = function (_DataDisposal) {
...
// WEBPACK FOOTER //
// ./src/lib/H3/Console/workflow/activity/activityEvent.js