<template>
    <div class="top-nav">
        <div class="top-nav-box">
            <!-- <img src="../../assets/images/logo.svg"  @click="returnToFront()" style="margin-left: 12px;">  -->
            <span style="color:#fff; font-size:16px;">{{topTitle}}</span>
...
// WEBPACK FOOTER //
// src/components/reporting/top-nav.vue